...
export const worldState = {
  library: { location: "Library", image: "/images/locations/library.jpeg", atmosphere: "quiet, book-scented air", people: ["Students studying"], events: ["Soft page turning"] },
  cafe_strada_internal: { location: "Inside Cafe Strada", image: "/images/locations/cafe_strada_internal.jpg", atmosphere: "warm espresso aroma", people: ["Barista making coffee"], events: ["Milk steamer hissing"] },
  quad: { location: "Quad", image: "/images/locations/quad.jpg", atmosphere: "breezy afternoon", people: ["Friends laughing on a bench"], events: ["Distant music from the student center"] },
  stadium: { location: "Stadium", image: "/images/locations/stadium.jpeg", atmosphere: "sunlight bouncing off concrete", people: ["Athletes warming up"], events: ["Distant cheering", "Whistle blowing"] },
  dream: { location: "Dream Space", image: "/images/locations/dream.webp", atmosphere: "uncertain", people: ["Echoes of past voices"], events: ["Hallways stretching infinitely"] }
};

// Non-Playable Character (NPC) Memory Tracking
export const npcMemory = {
  Vanessa: { lastInteraction: "ignored text", socialEnergy: "distant", relationshipStatus: "strained" },
  Jake: { lastInteraction: "flirty conversation", socialEnergy: "playful", relationshipStatus: "casual" },
  Maya: { lastInteraction: "complained about homework", socialEnergy: "stressed", relationshipStatus: "neutral" },
};

// Centralized Memory State (Short-Term, Mid-Term, and Core Memories)
export const memoryState = {
  shortTerm: [],  // Temporary experiences, fade quickly
